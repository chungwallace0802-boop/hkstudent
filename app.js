...
// 已經代入你的 Supabase 專案 ID: prlualxyvddrtpftumqo
const SUPABASE_URL = "https://prlualxyvddrtpftumqo.supabase.co";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBybHVhbHh5dmRkcnRwZnR1bXFvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc3NTAzNjMsImV4cCI6MjEwMzMyNjM2M30.ZSCQDc9k7ypnSKuEdQewsdWKpcsa-bAMLETt_VoQUBQ"; // 請替換成你 Supabase Dashboard -> Project Settings -> API 中的 anon key
